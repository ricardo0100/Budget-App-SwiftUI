...
class Persistency: NSObject {
    ...
    static private let currentUserKey = "CURRENT_USER"
...
//            }
    ...
    static var currentUser: User? {
        get {
            if let data = UserDefaults.standard.value(forKey: currentUserKey) as? Data {
        ...
        set {
            if let user = newValue {
                ...
                UserDefaults.standard.set(value, forKey: currentUserKey)
            } else {
                UserDefaults.standard.removeObject(forKey: currentUserKey)
            }
            OperationQueue.main.addOperation {
                currentUserPublisher.send(newValue)
            }
        }
    }
    
    static let currentUserPublisher = CurrentValueSubject<User?, Never>(currentUser)
